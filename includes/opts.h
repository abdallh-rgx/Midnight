...
namespace FCurlHookOpts {
    ...
    constexpr uintptr_t PR_ADDR = 0x089F02F0; // set this to the correct address (processrequest)
    constexpr uintptr_t GETURL_ADDR = 0x70; // set this to the correct address (geturl its mostly 0x70 until like s25/26+)
    constexpr uintptr_t SETURL_ADDR = 0x089EDCF8; // set this to the correct address (seturl)
}
